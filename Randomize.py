...
after_end = bytearray("\x33\x00\x00\x00/Game/Pal/Blueprint/Spawner/BP_PalSpawner_Standard", encoding="utf-8")
...
spawner_asset = "_Base/Pal/Content/Pal/DataTable/Spawner/DT_PalWildSpawner.uasset"
...
base_folder = "_Base/Pal/Content/Pal/Blueprint/Spawner/SheetsVariant"
...
for asset_name in os.listdir(base_folder):
    ...
    shutil.copy(base_folder + "/" + uexp_name, mod_folder + "/" + uexp_name)
